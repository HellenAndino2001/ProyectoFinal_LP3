    ...
    public class DetalleFacturaRepositorio : IDetalleFacturaRepositorio
    {
        ...
        public async Task<bool> Nuevo(DetalleFactura detalleFactura)
        {
            ...
            try
            {
                ...
                string sql = @"INSERT INTO detallefactura (idFactura, Descripcion, IdExamen, idMedicamento, Precio, Cantidad, Total) 
                               VALUES (@idFactura, @Descripcion, @IdExamen, @idMedicamento, @Precio, @Cantidad, @Total);";
